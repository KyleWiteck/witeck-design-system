...
sidebar_position: 1
description:
  Start your journey with Witeck Design, the Zero-runtime UI design library.
---

## Introduction

Start your journey with `@KyleWiteck/witeck-design`, the inhouse comprehensive
...
<Stack spacing="4">
  ...
  <Text variant="body1" textAlign="center">
    Enhance your development process with the <b>Witeck Design</b>, leveraging
    <Button
      element="a"
      marginX="2"
